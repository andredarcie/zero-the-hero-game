...
@onready var mage_magic_texture: Texture2D = preload("res://enemies/FireMage/mage_magic.png")
@onready var MagicBall: PackedScene = preload("res://enemies/FireMage/MagicBall/MagicBall.tscn")
@onready var mage_hurt: Texture2D = preload("res://enemies/FireMage/mage_hurt.png")
...
func shoot_magic_ball():
	var magic_ball = MagicBall.instantiate()
...
func load_magic_ball():
	...
	$Sprite2D.texture = mage_magic_texture
	$LoadingMagic.start()
...
func _on_Vision_body_exited(body):
	if body.is_in_group("Player"):
		$Sprite2D.texture = sprite_default
